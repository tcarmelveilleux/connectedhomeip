...
private:
    ...
    const OperationalState::GenericOperationalState mRvcOpStateList[8] = {
        OperationalState::GenericOperationalState(to_underlying(OperationalState::ChefRvcOperationalStateEnum::kStopped)),
        OperationalState::GenericOperationalState(to_underlying(OperationalState::ChefRvcOperationalStateEnum::kRunning)),
        OperationalState::GenericOperationalState(to_underlying(OperationalState::ChefRvcOperationalStateEnum::kPaused)),
        OperationalState::GenericOperationalState(to_underlying(OperationalState::ChefRvcOperationalStateEnum::kError)),
        OperationalState::GenericOperationalState(
            to_underlying(Clusters::RvcOperationalState::ChefRvcOperationalStateEnum::kSeekingCharger)),
        OperationalState::GenericOperationalState(to_underlying(Clusters::RvcOperationalState::ChefRvcOperationalStateEnum::kCharging)),
        OperationalState::GenericOperationalState(to_underlying(Clusters::RvcOperationalState::ChefRvcOperationalStateEnum::kDocked)),
        OperationalState::GenericOperationalState(to_underlying(Clusters::RvcOperationalState::ChefRvcOperationalStateEnum::kRunningWhileBeeping, "RunningWhileBeeping"_span)),
    };

    Clusters::RvcOperationalState::ChefRvcOperationalStateEnum mCurrentRunningState = OperationalState::ChefRvcOperationalStateEnum::kRunning;
};
