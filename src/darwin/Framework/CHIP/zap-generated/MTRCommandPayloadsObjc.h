...
MTR_PROVISIONALLY_AVAILABLE
@interface MTRDiscoBallClusterStartRequestParams : NSObject <NSCopying>
...
MTR_PROVISIONALLY_AVAILABLE
@interface MTRDiscoBallClusterStopRequestParams : NSObject <NSCopying>
/**
 * Controls whether the command is a timed command (using Timed Invoke).
 *
 * If nil (the default value), a regular invoke is done for commands that do
...
MTR_PROVISIONALLY_AVAILABLE
@interface MTRDiscoBallClusterReverseRequestParams : NSObject <NSCopying>
/**
 * Controls whether the command is a timed command (using Timed Invoke).
 *
 * If nil (the default value), a regular invoke is done for commands that do
...
MTR_PROVISIONALLY_AVAILABLE
@interface MTRDiscoBallClusterWobbleRequestParams : NSObject <NSCopying>
/**
 * Controls whether the command is a timed command (using Timed Invoke).
 *
 * If nil (the default value), a regular invoke is done for commands that do
...
MTR_PROVISIONALLY_AVAILABLE
@interface MTRDiscoBallClusterPatternRequestParams : NSObject <NSCopying>

@property (nonatomic, copy) NSString * _Nonnull passcode MTR_PROVISIONALLY_AVAILABLE;
/**
 * Controls whether the command is a timed command (using Timed Invoke).
 *
 * If nil (the default value), a regular invoke is done for commands that do
...
MTR_PROVISIONALLY_AVAILABLE
@interface MTRDiscoBallClusterStatsRequestParams : NSObject <NSCopying>
/**
 * Controls whether the command is a timed command (using Timed Invoke).
 *
 * If nil (the default value), a regular invoke is done for commands that do
...
MTR_PROVISIONALLY_AVAILABLE
@interface MTRDiscoBallClusterStatsResponseParams : NSObject <NSCopying>

@property (nonatomic, copy) NSNumber * _Nonnull lastRun MTR_PROVISIONALLY_AVAILABLE;

@property (nonatomic, copy) NSNumber * _Nullable patterns MTR_PROVISIONALLY_AVAILABLE;

/**
 * Initialize an MTRDiscoBallClusterStatsResponseParams with a response-value dictionary
 * of the sort that MTRDeviceResponseHandler would receive.
 *
 * Will return nil and hand out an error if the response-value dictionary is not
 * a command data response or is not the right command response.
