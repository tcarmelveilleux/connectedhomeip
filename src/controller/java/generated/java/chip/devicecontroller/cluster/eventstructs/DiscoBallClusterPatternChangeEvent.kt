...
class DiscoBallClusterPatternChangeEvent(
  val prevPattern: chip.devicecontroller.cluster.structs.DiscoBallClusterPatternStruct?,
  val curPattern: chip.devicecontroller.cluster.structs.DiscoBallClusterPatternStruct,
  val nextPattern: chip.devicecontroller.cluster.structs.DiscoBallClusterPatternStruct?,
  ...
  companion object {
    ...
    fun fromTlv(tlvTag: Tag, tlvReader: TlvReader): DiscoBallClusterPatternChangeEvent {
      ...
      val prevPattern =
        if (!tlvReader.isNull()) {
          chip.devicecontroller.cluster.structs.DiscoBallClusterPatternStruct.fromTlv(
