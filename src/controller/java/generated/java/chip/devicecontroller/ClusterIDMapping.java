...
public class ClusterIDMapping {
    ...
    public static BaseCluster getCluster(long clusterId) {
        ...
        if (clusterId == DiscoBall.ID) {
            return new DiscoBall();
        }
    ...
    public static class DiscoBall implements BaseCluster {
        public static final long ID = 13398L;
        public long getID() {
            return ID;
        }
        ...
        public enum Attribute {
            ...
            NameNameName(6L),
            WobbleSupport(7L),
            WobbleSettingWobbleSettingWobbleSetting(8L),
            GeneratedCommandList(65528L),
            AcceptedCommandList(65529L),
            EventList(65530L),
            AttributeList(65531L),
        ...
        public enum Command {
            ...
            public static Command value(long id) throws NoSuchFieldError {
                ...
                throw new NoSuchFieldError();
        ...
        }public enum StartRequestCommandField {Speed(0),Rotate(1),;
                    private final int id;
                    StartRequestCommandField(int id) {
                        this.id = id;
                    }
                    ...
                    public static StartRequestCommandField value(int id) throws NoSuchFieldError {
                        for (StartRequestCommandField field : StartRequestCommandField.values()) {
                        if (field.getID() == id) {
                            return field;
                        }
                        }
                ...
                }public enum PatternRequestCommandField {Passcode(0),;
                    private final int id;
                    PatternRequestCommandField(int id) {
                        this.id = id;
                    }
                    ...
                    public static PatternRequestCommandField value(int id) throws NoSuchFieldError {
                        for (PatternRequestCommandField field : PatternRequestCommandField.values()) {
                        if (field.getID() == id) {
                            return field;
                        }
                        }
